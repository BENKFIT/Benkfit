...
<html lang="en">
  ...
  <body class="eq-ui-layout-header-fixed eq-ui-side-nav-auto">
    <script>var _doc_route = {root_path:"components",path:"forms",name_section:"Components",name_chapter:"Forms"};</script>
<!--[if lt IE 9]>
...
&lt;/form&gt;</code></pre>
    ...
    <div class="row">
        <div class="col-md-12">
            <h2 class="header">Text Area</h2>
            <p>Add the class <code class="language-markup">eq-ui-textarea</code> in the textarea.</p>
            <form class="doc-form">
                <div class="row">
                    <div class="col-md-12">
                        <div class="eq-ui-form-group eq-ui-input-field">
...
&lt;/form&gt;</code></pre>
    ...
    <div class="row">
        <div class="col-md-12">
            <h2 class="header">Icon Fields</h2>
            <p>Add an icon with the class <code class="language-markup">prefix</code> before the input and label.</p>
            <form class="doc-form">
                <div class="row">
                    <div class="col-md-6">
                        <div class="row">
...
&lt;/form&gt;</code></pre>
    ...
    <div class="row">
        <div class="col-md-12">
            <h2 class="header">Validate Fields</h2>
            <p>You can add custom validation messages by adding either <code class="language-markup">data-error</code> or <code class="language-markup">data-success</code> attributes to your input field labels. For more info for validate, go to: <a href="/form-validation.html">Form Validation</a></p>
            <form class="doc-form">
                <div class="row">
                    <div class="col-md-12">
                        <div class="eq-ui-form-group eq-ui-input-field">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="eq-ui-form-group eq-ui-browser-select-field">
                            ...
                            <span class="eq-ui-caret"></span>
                            <label>Disabled Browser Select</label>
                        </div>
                    </div>
                </div>
            </form>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="eq-ui-form-group eq-ui-input-field">
                            ...
                            <label>Disabled Normal Select</label>
                        </div>
                    </div>
                </div>
            </form>
...
...</code></pre>
    ...
    <div id="forms-search" class="row">
        ...
        <div class="col-md-6">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="header">Search Expandable</h2>
                    <form class="doc-form">
                        <div class="row">
                            <div class="col-md-12">
...
&lt;/form&gt;</code></pre>
    ...
    <div id="forms-autocomplete" class="row">

        <div class="col-md-12">
            <h2 class="header">Autocomplete</h2>
            <p>Based in <a target="_blank" href="https://github.com/devbridge/jQuery-Autocomplete">jQuery-Autocomplete</a> plugin. For more info and view the documentation, go to: <a target="_blank" href="https://www.devbridge.com/sourcery/components/jquery-autocomplete/">jquery-autocomplete</a></p>
        </div>

        <div class="col-md-12">
            <div class="row">
                <div class="col-md-12">
                    <h5 class="header">Search</h5>
                    <form class="doc-form">
                        <div class="row">
                            <div class="col-md-12">
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-12">
                    <h5 class="header">Search expandable</h5>
                    <form class="doc-form">
                        <div class="row">
                            <div class="col-md-12">
...
<pre><code class="language-javascript">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="#" class="doc-margin-bottom">
                <div class="row">
                    <div class="col-md-12">
...
&lt;/form&gt;</code></pre>
            ...
            <h2 class="header">File Input - Image Preview</h2>
            <p>Image preview for upload</p>

            <!-- Avatar -->
            <ul class="eq-ui-list eq-ui-hoverable doc-margin-bottom">
                <li id="img-preview-file_input_test3" class="eq-ui-list-item eq-ui-list-avatar eq-ui-list-truncate">
                    <img class="circle img-preview" src="/benkfit/resources/assets/img/doc/avatar/avatar_0.jpg">
...
&lt;/form&gt;</code></pre>
    ...
    <div id="forms-file-upload-drop" class="row">
        <div class="col-md-12">
            <h2 class="header">File Upload - Drag and Drop</h2>
            <p>Based in <a target="_blank" href="https://github.com/enyo/dropzone">DropzoneJS</a> plugin. For more info and view the documentation, go to: <a target="_blank" href="http://www.dropzonejs.com/#configuration-options">DropzoneJS Doc</a></p>

            <ul class="eq-ui-list eq-ui-file-upload-drop-zone doc-margin-bottom">
...
$(document).ready(function(){
    ...
    var _dropzone = EqUI.forms.file_upload_drop('.eq-ui-file-upload-drop-zone', {
        ...
        defaultImageThumbnail: "/benkfit/resources/assets/img/doc/files/empty.png"
    });
