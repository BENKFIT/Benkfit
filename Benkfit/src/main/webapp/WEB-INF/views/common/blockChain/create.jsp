...
<body>
	...
	<div
		...
		<div style="display: inline-block; width: 60%; margin: 200px 0px;">
			...
			<br> <input type="password" id="password" value="password">
			<input type="button" value="확인" onclick="create();"> <br>
			<br>
			<br>
			<p>
				당신의 지갑은 키스토어로 만들어집니다.<br> 당신의 지갑 계정은 서버에 안전하게 귀속됩니다.<br>
				당신의 지갑으로 이더 거래, 토큰까지 받을 수 있습니다.<br> 계정 생성이 완료되면 당신의 지갑주소를
				알려드리겠습니다.<br> 절대로 잊어버리지 마세요.<br> 우리는 보안에 최선을 다 할 것입니다.<br>
				<br> 현재 풀노드의 수..... 5<br>
			</p>
		</div>
	</div>
